      ...
      >
        <defs>
          ...
          <linearGradient id="gradient4" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#ff0088" stopOpacity="0.6" />
            <stop offset="50%" stopColor="#ff0088" stopOpacity="0.3" />
            <stop offset="100%" stopColor="#ff0088" stopOpacity="0.6" />
          </linearGradient>
          ...
          <linearGradient id="gradient6" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#ff88ff" stopOpacity="0.6" />
            <stop offset="50%" stopColor="#ff88ff" stopOpacity="0.3" />
            <stop offset="100%" stopColor="#ff88ff" stopOpacity="0.6" />
          </linearGradient>
        </defs>
